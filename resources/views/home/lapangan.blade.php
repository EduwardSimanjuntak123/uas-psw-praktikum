...
@section('page-content')
    <section class="hero-wrap hero-wrap-2" style="background-image: url('{{ asset('bg2.jpg') }}');"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($lapangan as $p)
                    <div class="col-md-4 " >
                        <div class="product ftco-animate shadow" style="background-color: #000000">
                            <div class="shadow">
                                <a href="#" data-toggle="modal" data-target="#detail<?= $no ?>">
                                    ...
                                    <div class="text text-center">
                                        ...
                                        <p class="mb-0"><span class="price text-white">Rp
                                                {{ number_format($p->hargalapangan) }}/jam</span></p>
                                        <hr>
                                    </div>
                                </a>
                            </div>
